    ...
    <div id="base" class="">
      ...
      <div id="u0" class="ax_default heading_1">
        ...
        <div id="u1" class="text">
          <p><span style="font-family:'Brush Script MT Italic Bold', 'Brush Script MT';font-style:italic;color:#336600;">Pampers</span><span style="font-family:'Arial Bold', 'Arial';font-style:normal;"> - </span><span style="font-family:'Berlin Sans FB Bold', 'Berlin Sans FB';font-style:normal;color:#FF9900;">金质睡眠</span></p>
        </div>
      </div>
    </div>
  </body>
...
.intro {
  ...
  <body>
    <div class="container">
        ...
        <p class="intro">Verify whether two faces belong to a same person or whether one face belongs to a person. </p>
